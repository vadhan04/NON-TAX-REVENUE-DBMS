...
<div class="container">
    ...
    <h2 style="color: #ffffff;">OUTCOME</h2>
    <p style="color: #ffffff;">This page allows you to see and update the OUTCOME of the scheme. Changes will reflect in the database.</p>
</div>
...
<table>
    ...
    $sql = "SELECT scheme_name, outcome FROM scheme";
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_outcome'])) {
        ...
        $updateSql = "UPDATE scheme SET outcome = '$newOutcome' WHERE scheme_name = '$schemeName'";
