...
<div class="container">
    <h2 style="color: #ffffff;">Document</h2>
    <a href="home.php" class="button" style="top: 85px;float:right;"><button>Homepage</button></a>
    <p style="color: #ffffff;">This page allows you to see and update the Document of the scheme. Changes will reflect in the database.</p>
</div>
...
<table>
    ...
    $sql = "SELECT scheme_name, document FROM scheme";
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_outcome'])) {
        ...
        $updateSql = "UPDATE scheme SET document = '$newOutcome' WHERE scheme_name = '$schemeName'";
